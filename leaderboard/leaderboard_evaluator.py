...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args):
        """
...
def main():
    ...
    parser.add_argument('--host', default=os.environ["CARLA_IP"],
    ...
    parser.add_argument('--routes',
                        ...
                        # required=True)
                        default="routes_town10_short.xml")
    parser.add_argument('--scenarios',
                        help='Name of the scenario annotation file to be mixed with the route.',
                        # required=True)
                        default="town10_all_scenarios.json")
    ...
    parser.add_argument("-a", "--agent", type=str, help="Path to Agent's py file to evaluate", default="leaderboard/team_code/interfuser_agent.py")
    # parser.add_argument("--agent-config", type=str, help="Path to Agent's configuration file", default="")
    parser.add_argument("--agent-config", type=str, help="Path to Agent's configuration file", default="leaderboard/team_code/interfuser_config.py")
